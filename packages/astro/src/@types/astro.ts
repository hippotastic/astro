 ...
 *
 * [Full Documentation](https://docs.astro.build/reference/api-reference/#astro-global)
 */
export interface AstroGlobal extends AstroGlobalPartial {
	 ...
	 *
	 * [Full Documentation](https://docs.astro.build/en/reference/api-reference/#astrocanonicalurl)
	 */
	canonicalURL: URL;
	 ...
	 * ```
	 *
	 * [Full Documentation](https://docs.astro.build/en/reference/api-reference/#params)
	 */
	params: Params;
	 ...
	 * ```
	 *
	 * [Full Documentation](https://docs.astro.build/en/core-concepts/astro-components/#component-props)
	 */
	 ...
	 * ```
	 *
	 * [Full Documentation](https://docs.astro.build/en/reference/api-reference/#astrorequest)
	 */
	request: Request;
	 ...
	 * ```
	 *
	 * [Full Documentation](https://docs.astro.build/en/guides/server-side-rendering/#astroredirect)
	 */
	redirect(path: string): Response;
	/**
	 * The <Astro.self /> element allows a component to reference itself recursively.
	 *
	 * [Full Documentation](https://docs.astro.build/en/guides/server-side-rendering/#astroself)
	 */
	self: AstroComponentFactory;
	/** Utility functions for modifying an Astro component’s slotted children
	 *
	 * [Full Documentation](https://docs.astro.build/en/reference/api-reference/#astroslots)
	 */
...
export interface AstroGlobalPartial {
	 ...
	 * ```
	 *
	 * [Full Documentation](https://docs.astro.build/en/reference/api-reference/#astroglob)
	 */
	 ...
	 *
	 * [Full Documentation](https://docs.astro.build/en/reference/api-reference/#astrosite)
	 */
	site: URL;
}
